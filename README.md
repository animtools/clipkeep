...
ClipKeep は、動画をシーン単位のタイルに分解して一覧し、気になった瞬間を Keep してコレクションできる Windows 向けの動画ライブラリアプリです。動画素材や録画をたくさん溜めている人が、中身を開かずに眺めて探し、使いたい数秒を残しておくための道具です。
...
- 有料プラン: 書き出し
- All-Access（サブスク）: 書き出しに加えて、スキャン実験室の顔・ポーズ・シーン検出・文字起こし
